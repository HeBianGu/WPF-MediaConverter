...
namespace System.Linq
{
    ...
    public static class ObjectExtend
    {
        ...
        public static void CopyFromObj(this object obj, object v, bool isUpper = false)
        {
            ...
            var thisfields = obj.GetType().GetProperties(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static).ToList();
