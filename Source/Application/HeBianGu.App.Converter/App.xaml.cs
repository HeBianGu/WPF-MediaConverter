...
namespace HeBianGu.App.Converter
{
    ...
    public partial class App : ApplicationBase
    {
        ...
        protected override void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddComputerInfosViewPresenter(x =>
            //{
            //    //x.Collection.Add(new Win32_OperatingSystem());
            //    //x.Collection.Add(new Win32_ComputerSystemProduct());
            //    //x.Collection.Add(new Win32_Processor());
            //    //x.Collection.Add(new Win32_PhysicalMemory());
            //    //x.Collection.Add(new Win32_DiskDrive());
            //    //x.Collection.Add(new Win32_BaseBoard());
            //    //x.Collection.Add(new Win32_VideoController());
            //    //x.Collection.Add(new Win32_SoundDevice());
            //});
